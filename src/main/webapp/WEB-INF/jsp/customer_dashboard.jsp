...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="/customer/new-package" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">${pendingPackages.size()}</div>
                        </div>
                        <div class="col-auto">
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">
                                In Transit</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">${inTransitPackages.size()}</div>
                        </div>
                        <div class="col-auto">
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                Delivered</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">${deliveredPackages.size()}</div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-header py-3">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered" id="deliveryHistoryTable" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                <c:forEach items="${deliveredPackages}" var="deliveryPackage">
                                    <tr>
                                        <td>${deliveryPackage.package_id}</td>
                                        <td>${deliveryPackage.pickupAddress}</td>
                                        <td>${deliveryPackage.deliveryAddress}</td>
